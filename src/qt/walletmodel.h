...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        IXTransactionCreationFailed, // Error returned when InstandSend fails in prepareTransaction
        PrepareTransactionFailed, // Error returned when InstandSend fails in prepareTransaction
