// Copyright (c) 2015 The RUP developers
...
bool IsSporkActive(int nSporkID)
{
    ...
    if(mapSporksActive.count(nSporkID)){
        ...
        if(nSporkID == SPORK_2_INSTANDSEND) r = SPORK_2_INSTANDSEND_DEFAULT;
        if(nSporkID == SPORK_3_INSTANDSEND_BLOCK_FILTERING) r = SPORK_3_INSTANDSEND_BLOCK_FILTERING_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if(strName == "SPORK_2_INSTANDSEND") return SPORK_2_INSTANDSEND;
    if(strName == "SPORK_3_INSTANDSEND_BLOCK_FILTERING") return SPORK_3_INSTANDSEND_BLOCK_FILTERING;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if(id == SPORK_2_INSTANDSEND) return "SPORK_2_INSTANDSEND";
    if(id == SPORK_3_INSTANDSEND_BLOCK_FILTERING) return "SPORK_3_INSTANDSEND_BLOCK_FILTERING";
