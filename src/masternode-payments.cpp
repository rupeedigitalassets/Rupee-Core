...
bool CMasternodePayments::CheckSignature(CMasternodePaymentWinner& winner)
{
    ...
    if(!privateSendSigner.VerifyMessage(pubkey, winner.vchSig, strMessage, errorMessage)){
        return false;
    }
...
bool CMasternodePayments::Sign(CMasternodePaymentWinner& winner)
{
    ...
    if(!privateSendSigner.SignMessage(strMessage, errorMessage, winner.vchSig, key2)) {
        LogPrintf("CMasternodePayments::Sign - Sign message failed");
        return false;
    }

    if(!privateSendSigner.VerifyMessage(pubkey2, winner.vchSig, strMessage, errorMessage)) {
