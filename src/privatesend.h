...
extern CDarkSendSigner privateSendSigner;
...
{
public:
    /// Is the inputs associated with this public key? (and there is 20000 RUP - checking if valid masternode)
