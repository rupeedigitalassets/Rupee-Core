...
#define START_MASTERNODE_PAYMENTS_TESTNET 1525856400 //Wednesday, May 9, 2018 9:00:00 AM GMT
#define START_MASTERNODE_PAYMENTS 1525856400 //Wednesday, May 9, 2018 9:00:00 AM GMT

static const int64_t PRIVATESEND_COLLATERAL = (0.01*COIN);
static const int64_t PRIVATESEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 50 * COIN; //Constant reward of 50 RUP per COIN.
static const int64_t TARGET_SPACING = 300; //300 sec


#define INSTANDSEND_SIGNATURES_REQUIRED           10
#define INSTANDSEND_SIGNATURES_TOTAL              15
...
static const int64_t MAX_MONEY = 84000000 * COIN;  // 84M COIN
