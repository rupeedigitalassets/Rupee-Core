...
private slots:
    ...
    QString BuyRUP(QString OrderType, double Quantity, double Rate);
    QString SellRUP(QString OrderType, double Quantity, double Rate);
